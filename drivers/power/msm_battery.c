...
#if (defined(CONFIG_MACH_MSM7X27_THUNDERG) || defined(CONFIG_MACH_MSM7X27_PECAN) || defined(CONFIG_MACH_MSM7X27_HAZEL)) && defined CONFIG_PM  /* 20100911 pecan porting temp same as thunderg by bongkyu.kim */
...
static u32 msm_batt_capacity(u32 value)
{
#if defined(CONFIG_LGE_FUEL_GAUGE) || defined(CONFIG_LGE_FUEL_SPG)
// LGE_CHANGE_S dangwoo.choi@lge.com
...
// LGE_CHANGE_E dangwoo.choi@lge.com
	...
	if (value <= low_voltage)
		return 0;
	else if (value >= high_voltage)
		return 100;
	else
		return (value - low_voltage) * 100
...
#if (defined(CONFIG_MACH_MSM7X27_THUNDERG) || defined(CONFIG_MACH_MSM7X27_PECAN) || defined(CONFIG_MACH_MSM7X27_HAZEL)) && defined CONFIG_PM /* 20100911 pecan porting same as thunderg by bongkyu.kim */
