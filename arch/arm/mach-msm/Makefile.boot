...
ifeq ($(CONFIG_LGE_4G_DDR),y)
	...
	initrd_phys-$(CONFIG_MACH_MSM7X27_THUNDERG)	:= 0x13800000
	   ...
	   zreladdr-$(CONFIG_MACH_MSM7X27_THUNDERC)	:= 0x12208000
	params_phys-$(CONFIG_MACH_MSM7X27_THUNDERC)	:= 0x12200100
	initrd_phys-$(CONFIG_MACH_MSM7X27_THUNDERC)	:= 0x13200000

	   zreladdr-$(CONFIG_MACH_MSM7X27_THUNDERA)	:= 0x12808000
	...
	initrd_phys-$(CONFIG_MACH_MSM7X27_PECAN)	:= 0x03800000	
	   ...
	   zreladdr-$(CONFIG_MACH_MSM7X27_HAZEL)	:= 0x02808000
	params_phys-$(CONFIG_MACH_MSM7X27_HAZEL)	:= 0x02800100
	initrd_phys-$(CONFIG_MACH_MSM7X27_HAZEL)	:= 0x03800000	
else	
