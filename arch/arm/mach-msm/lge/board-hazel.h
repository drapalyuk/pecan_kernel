/* arch/arm/mach-msm/include/mach/board_hazel.h
 ...
 */
#ifndef __ARCH_MSM_BOARD_HAZEL_H
#define __ARCH_MSM_BOARD_HAZEL_H
...
#define PP2106_KEYPAD_COL	6

#define GPIO_PP2106_RESET	41
...
void hazel_pwrsink_resume(void);

struct device* hazel_backlight_dev(void);
#endif
