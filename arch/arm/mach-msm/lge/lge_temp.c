...
static unsigned long long update_time = 0LL;
...
static int result_show(struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	update_time = (((unsigned long long)buf11[11] << 56) | ((unsigned long long)buf11[10] << 48) | ((unsigned long long)buf11[9] << 40) | ((unsigned long long)buf11[8] << 32) |
					((unsigned long long)buf11[7] << 24) | ((unsigned long long)buf11[6] << 16) | ((unsigned long long)buf11[5] << 8) | (unsigned long long)buf11[4]);

	return sprintf(buf, "%d:%llu\n", test_result, update_time);
}
...
static int result_store(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
	...
	memcpy(buf11+4, &update_time, sizeof(unsigned long long));
