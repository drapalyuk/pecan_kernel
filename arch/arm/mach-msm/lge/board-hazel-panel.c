/* arch/arm/mach-msm/board-hazel-panel.c
...
void __init hazel_init_i2c_backlight(int bus_num)
{
...
//	platform_device_register(&mddi_hitachi_panel_device);
	...
	lge_add_gpio_i2c_device(hazel_init_i2c_backlight);
}
