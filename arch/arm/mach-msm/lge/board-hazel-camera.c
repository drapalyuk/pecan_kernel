/* arch/arm/mach-msm/board-hazel-camera.c
...
static struct platform_device *hazel_camera_devices[] __initdata = {
#if defined (CONFIG_ISX005)
...
{
	platform_add_devices(hazel_camera_devices, ARRAY_SIZE(hazel_camera_devices));
}
