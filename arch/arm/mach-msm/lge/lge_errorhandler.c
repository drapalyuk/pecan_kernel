...
char * android_errhanlder_ptr = NULL;
 ...
 int LGE_ErrorHandler_Main( int crash_side, char * message)
 {
	...
	gpio_tlmm_config(GPIO_CFG(32, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA), GPIO_ENABLE);	
	gpio_tlmm_config(GPIO_CFG(33, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA), GPIO_ENABLE);	
	gpio_tlmm_config(GPIO_CFG(37, 0, GPIO_INPUT, GPIO_PULL_UP, GPIO_2MA), GPIO_ENABLE);	
